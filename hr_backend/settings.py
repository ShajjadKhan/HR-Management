...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-z0m&r7n6wj^8@qy=_$m9anlz0+wx_)(cyqx4p%++p71dzbsvb1')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'employees.context_processors.tenant_context',
            ],
...
# Maximum Security & Tamper Resistance
